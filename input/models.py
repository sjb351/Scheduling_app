...
class proccess(models.Model):
    ...
    setUpTime = models.DurationField(default = d0, null=True, blank=True)
    stopTime = models.DurationField(default = d0, null=True, blank=True)
...
class machine(models.Model):
    ...
    proccess = models.ForeignKey(proccess, on_delete=models.PROTECT,null=True, blank =True)
...
class worker(models.Model):
    ...
    useable = models.BooleanField(default=True)
    proccess = models.ForeignKey(proccess, on_delete=models.PROTECT,null=True, blank =True)
    numberParra = models.PositiveBigIntegerField(default=1)
